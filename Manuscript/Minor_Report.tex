...
%\linenumbers
%\noindent
\includepdf[pages={1-2}]{Certificate .pdf}
\includepdf[pages={1}]{Certificate_TEcoEvo.pdf}
\tableofcontents
\newpage
...
So, we will proceed with stochastic processes.
...
\begin{figure}[H]
    ...
    At time step $3000$, the cooperators are $42.9\%$ and defectors are $57.1\%$. This is only one stochastic step.}
    \label{fig:7}
\end{figure}
...
\begin{figure}[ht]
 ...
 \caption{This figure is used to show the if the NWS network and well-mixed population, crossing the analytical unstable tipping point.}
  \label{fig:9}
\end{figure}
As future directions of this report, we're going to walk through the multi-player game dynamics, dynamic networks and the application of this framework to understand biological systems such as cellular dynamics of burn wound healing.
