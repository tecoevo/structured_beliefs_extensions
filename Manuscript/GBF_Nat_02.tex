...
\begin{equation}
\pi_R= i_S - i_P \label{eq:26}
\end{equation}
\begin{equation}
\pi_S= i_P - i_R \label{eq:27}
\end{equation}
\begin{equation}
\pi_P= i_R - i_S \label{eq:28}
\end{equation}
...
\begin{equation}
T_{P \to R} = \frac{i_R f_R}{i_R f_R + i_S f_S + i_P f_P}\times \frac{i_P f_P^{-1}}{i_R f_R^{-1} + i_S f_S^{-1} + i_P f_P^{-1}} \label{eq:29}
\end{equation}
...
\end{enumerate}
From the equations \eqref{eq:26}, \eqref{eq:27}, \eqref{eq:28} we can find the point sets in the simplex where two or more payoff is equal. $\pi_R=\pi_S=\pi_P$ is the only center point of the simplex.
...
2i_P &=i_S+N-i_P-i_S \nonumber\\
3i_P &= N \nonumber\\
i_P &= \frac{N}{3} \label{eq:30}
\end{align}
\item The second equation is $\pi_S=\pi_P$ and after solving it like \eqref{eq:30} we get $i_R=\frac{N}{3}$.
\item The third equation is $\pi_S=\pi_P$ and after solving it like \eqref{eq:30} we get $i_S=\frac{N}{3}$.
\end{enumerate}
