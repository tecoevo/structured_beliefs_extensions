...
\end{figure}
In this case, from $0$ to the equilibrium point ($1/3$) will show defection and  $(1/3,1)$ will cooperate.\\
...
\[x=\frac{1}{3}\]
\[x^*=\frac{1}{3}\]
If we notice, the chicken game and snowdrift game's mixed equilibrium point is the same as their payoff structure, but where does the difference lie?\\
...
\end{figure}
In this case, from $0$ to the equilibrium point ($1/3$) will show defection and more $(1/3,1)$ will cooperate.\\
